            ...
            <div class="flex h-full flex-col">
              ...
              <div class="pt-10">
                <div class="h-full max-h-full">
                    <aside class="h-full bg-white lg:sticky xl:block xl:w-72  lg:top-20">
                      <div class="max-h-full grow overflow-hidden">
                        <div data-overlayscrollbars-initialize="" class="os-theme-thin-dark max-h-screen w-full" data-overlayscrollbars="host" style="height: calc(100vh - 5.35rem);">
                        <div  style="margin-right: 0px; margin-bottom: 0px; margin-left: 0px; top: 0px; right: auto; left: 0px; width: calc(100% + 0px); padding: 0px;">
                          <div class="px-5">
